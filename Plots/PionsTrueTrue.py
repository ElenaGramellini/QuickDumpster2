...
data_FileName       = "/Volumes/Seagate/Elena/TPC/TruePionGen.root"
...
legend.AddEntry(XSDataRecoPion,"True Tot XS")
legend.AddEntry(XSDataOldGeoRecoPion,"True After Selection Tot XS")
legend.Draw("same")
c1.Update()
