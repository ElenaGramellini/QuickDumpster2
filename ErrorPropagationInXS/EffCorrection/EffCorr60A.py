...
moveXS_45 = eff_Corr_45_Int.Clone("move_XS_45_60A")
moveXS_45.Divide(eff_Corr_45_Inc)   
...
moveXS_All = eff_Corr_All_Int.Clone("move_XS_All_60A")
moveXS_All.Divide(eff_Corr_All_Inc)   
