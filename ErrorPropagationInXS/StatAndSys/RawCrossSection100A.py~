...
legendInt.AddEntry(hInteractingKE_Stat,"-100A Data Stat Only");
legendInt.AddEntry(grInt,   "-100A Data Stat and Sys");
legendInt.Draw("same")
p1.Update()
...
legendInc.AddEntry(hIncidentKE_Stat,"-100A Data Stat Only");
legendInc.AddEntry(grInc,   "-100A Data Stat and Sys");
legendInc.Draw("same")
p2.Update()
