...
legendInt.AddEntry(secoMC_Int,"MC 100A predicted secondaries");
legendInt.AddEntry(muonMC_Int,"MC 100A predicted muons");
...
legendInc.AddEntry(secoMC_Int,"MC 100A predicted secondaries");
legendInc.AddEntry(muonMC_Int,"MC 100A predicted muons");
