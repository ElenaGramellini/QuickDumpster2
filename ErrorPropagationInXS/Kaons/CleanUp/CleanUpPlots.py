...
inFileName = "/Volumes/Seagate/Elena/TPC/Kaons/MCKaon_Picky.root"
...
hInteractingKEFB   = TH1D("hInteractingKEFB","hInteractingKEFB" , 100,0,50)

hInteractingKE   = TH1D("hInteractingKE","hInteractingKE" ,10*(hInteractingKEComp.GetSize()-2), hInteractingKEComp.GetXaxis().GetXmin(),  hInteractingKEComp.GetXaxis().GetXmax())
hIncidentKE      = TH1D("hIncidentKE"   ,"hIncidentKE"    ,10*(hIncidentKEComp.GetSize()   -2), hIncidentKEComp.GetXaxis().GetXmin()   ,  hIncidentKEComp.GetXaxis().GetXmax()   )

hInteractingKEMax = TH1D("hInteractingKEMax","hInteractingKEMax",10*(hInteractingKEComp.GetSize()-2), hInteractingKEComp.GetXaxis().GetXmin(),  hInteractingKEComp.GetXaxis().GetXmax())
hIncidentKEMax    = TH1D("hIncidentKEMax"   ,"hIncidentKEMax"   ,10*(hIncidentKEComp.GetSize()  -2), hIncidentKEComp.GetXaxis().GetXmin()   ,  hIncidentKEComp.GetXaxis().GetXmax()   )

hInteractingKEMin = TH1D("hInteractingKEMin","hInteractingKEMin",10*(hInteractingKEComp.GetSize()-2), hInteractingKEComp.GetXaxis().GetXmin(),  hInteractingKEComp.GetXaxis().GetXmax())
hIncidentKEMin    = TH1D("hIncidentKEMin"   ,"hIncidentKEMin"   , 10*(hIncidentKEComp.GetSize()  -2), hIncidentKEComp.GetXaxis().GetXmin()   ,  hIncidentKEComp.GetXaxis().GetXmax()   )

uncertaintyEDep     = 0.18
...
#          continue
     ...
     if isTrackInteracting:
         if recoKESkim[len(recoKESkim)-1] < 50 :
           hInteractingKEFB.Fill(recoKESkim[len(recoKESkim)-1])
