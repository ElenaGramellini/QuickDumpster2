...
leg->SetHeader("LArIAT Negative Polarity -100A");
leg->AddEntry(hDataDepE,"Data");
leg->AddEntry(hMCDepE,"#pi^{-} MC"); 
leg->AddEntry(dataFit_histo,"Data Fit: MPV = 0.775 #sigma = 0.078");
leg->AddEntry(MCFit_histo," MC  Fit: MPV = 0.762 #sigma = 0.059");
leg->Draw();
