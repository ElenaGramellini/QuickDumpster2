#define SanityChecks_Data_cxx
#include "SanityChecks_Data.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
TFile myfile("./Data_SanityPlots.root","RECREATE");
hRecoEndZ->Write();
hRecoEndY->Write();
hRecoEndX->Write();
hRecoIntKEvsLength->Write();

}//<---End SanityChecks_Data::Loop()
