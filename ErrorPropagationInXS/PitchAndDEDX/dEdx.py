...
legend = TLegend(0.38,0.65,0.48,0.88);
...
legend.AddEntry(data_dedx_landau,"Data Fit: MPV = 1.67 #sigma = 0.42");
legend.AddEntry(mc_dedx_landau," MC  Fit: MPV = 1.65 #sigma = 0.11");
