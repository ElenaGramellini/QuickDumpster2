...
effCorrData_XS.SetTitle("Raw Data and Reco #pi/#mu/e MC; Kinetic Energy [MeV]; Cross Section per 50 MeV [barn]")
...
rawMC.Draw("histo")
recoMCPion_XS.Draw("samehisto")
trueMCPion_XS.Draw("samehisto")
