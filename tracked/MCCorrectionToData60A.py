...
backgroundCorrection_FileName = 'Out_1.0Muons_1.0Electrons_60A.root'
backgroundCorrection_File = TFile.Open(backgroundCorrection_FileName)
backgroundCorrection_Int  = backgroundCorrection_File.Get("backgroundCorrection_Int60A")
backgroundCorrection_Inc  = backgroundCorrection_File.Get("backgroundCorrection_Inc60A")
XS_MC = backgroundCorrection_File.Get("MC_PionOnlyRecoXS60A")
...
efficiencyCorrection_Int  = efficiencyCorrection_File.Get("multEffCorr_Int")
efficiencyCorrection_Inc  = efficiencyCorrection_File.Get("multEffCorr_Inc")
trueXS  = efficiencyCorrection_File.Get("XSTrue")
...
rawXS.SetLineColor(kRed)
bkgSubXS.SetLineColor(kRed-2)
effCorrXS.SetLineColor(kRed-4)
rawXS.SetMarkerColor(kRed)
bkgSubXS.SetMarkerColor(kRed-2)
effCorrXS.SetMarkerColor(kRed-4)

outFile = TFile("DataCorrected60A.root","recreate")
outFile.cd()
rawXS.Write("pionXS_Raw60A"       ,TObject.kWriteDelete)
bkgSubXS.Write("pionXS_DataBkgSub60A"       ,TObject.kWriteDelete)
effCorrXS.Write("pionXS_DataBkgSubEffCorr60A",TObject.kWriteDelete)
