...
################################################ Data
pionData_RecoData  = TFile.Open("BackgroundSub.root")

intRecoData60A      = pionData_RecoData.Get ("intRecoData60A_Bkg")
incRecoData60A      = pionData_RecoData.Get ("incRecoData60A_Bkg")
intRecoData100A     = pionData_RecoData.Get("intRecoData100A_Bkg")
incRecoData100A     = pionData_RecoData.Get("incRecoData100A_Bkg")
...
intRecoData60A .Divide(Efficiency_Int_60A)
#incRecoData60A_Eff .Divide(Efficiency_Inc_60A)
intRecoData100A.Divide(Efficiency_Int_100A)
